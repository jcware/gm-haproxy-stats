(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		define("gmHaproxyStats", [], factory);
	else if(typeof exports === 'object')
		exports["gmHaproxyStats"] = factory();
	else
		root["gmHaproxyStats"] = factory();
})(this, function() {
...
exports.default = { fetchCSV: _main.fetchCSV, toArray: _main.toArray, toJson: _main.toJson };
...
exports.fetchCSV = exports.toJson = exports.toArray = undefined;

var _toArray4 = __webpack_require__(28);
...
var fetchCSV = function fetchCSV(url) {
  return (0, _request2.default)(url).then(function (dataText) {
    return toJson(dataText);
  });
};
...
var toJson = function toJson(strData) {
  var _toArray = toArray(strData),
      _toArray3 = (0, _toArray5.default)(_toArray),
      head = _toArray3[0],
...
//# sourceMappingURL=gm-haproxy-stats.js.map